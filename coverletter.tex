...
%-------------------------------------------------------------------------------
% \worktitle{Master Thesis: Computer Vision and Machine Learning at Tobii}
...
\mobile{}
\email{dongwang@wangdongdong.wang}
% \homepage{wangdongdong.wang}
% \github{nanguoyu}
\linkedin{dongwangwilliam}
% \gitlab{gitlab-id}
